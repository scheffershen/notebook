...
def process_text_files(dir_path, out_path, filename):
...
if __name__ == "__main__":
    ...
    # Vérifier si le fichier existe dans le répertoire "dir_path"
    if os.path.exists(os.path.join(dir_path, file_name)):
        # Traiter le fichier avec le nom "file_name" dans le répertoire "dir_path"
        process_text_files(dir_path, out_path, file_name)
    else:
        # Afficher un message d'erreur si le fichier n'existe pas dans le répertoire "dir_path"
        print("Le fichier", file_name, "n'existe pas dans le répertoire", dir_path)